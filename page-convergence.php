...
?>
    <div class="page-title tw-w-full tw-block  tw-relative tw--mt-[200px] tw-pt-[200px]" >
        <div class="tw-container tw-mx-auto tw-px-4 tw-h-min-[200px] tw-pb-[80px] tw-pt-12">
            ...
            <p class="tw-text-light tw-text-sm tw-text-white tw-pt-2 tw-pl-5">Create the knowledge needed to solve complex problems of resilience and sustainability in the multi-scale and telecoupled contexts through geospatial data-intensive and multi-type (AI, theory-based, and mechanistic) analysis and modeling</p>
        </div>
